...
def main() :
    ...
    generator = dataGen.flow_from_directory('C:\\Users\\HwangJeongyeon\\Desktop\\posenet_data\\train_dataset', shuffle = True, target_size=(tf_size,tf_size), batch_size=32, class_mode = 'categorical')
